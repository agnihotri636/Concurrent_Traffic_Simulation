...
#include "Graphics.h"
#include "config/TrafficObjectConfig.h"


using namespace std;

// Method to create a traffic object
void TrafficObjectCreator::createTrafficObjects_Paris(vector<shared_ptr<Street>> &streets, vector<shared_ptr<Intersection>> &intersections, vector<shared_ptr<Vehicle>> &vehicles, string &filename, int nVehicles)
{
    // assign filename of corresponding city map
    filename = "../src/images/paris.jpg";
...
void TrafficObjectCreator::createTrafficObjects_FSU(std::vector<std::shared_ptr<Street>> &streets, std::vector<std::shared_ptr<Intersection>> &intersections, std::vector<std::shared_ptr<Vehicle>> &vehicles, std::string &filename, int nVehicles)
{
    // assign filename of corresponding city map
    filename = "../src/images/fsu.jpeg";
    ...
    intersections.at(0)->setPosition(917,435);
    intersections.at(1)->setPosition(747,360);
    intersections.at(2)->setPosition(625,312);
    intersections.at(3)->setPosition(1487,659);
    intersections.at(4)->setPosition(913,714);
...
// NYC
void TrafficObjectCreator::createTrafficObjects_NYC(std::vector<std::shared_ptr<Street>> &streets, std::vector<std::shared_ptr<Intersection>> &intersections, std::vector<std::shared_ptr<Vehicle>> &vehicles, std::string &filename, int nVehicles)
{
    // assign filename of corresponding city map
    filename = "../src/images/nyc.jpg";
